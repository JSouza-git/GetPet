...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post cargos_url, params: { cargo: { descricao: @cargo.descricao, nome: @cargo.nome, permissao: @cargo.permissao } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { descricao: @cargo.descricao, nome: @cargo.nome, permissao: @cargo.permissao } }
