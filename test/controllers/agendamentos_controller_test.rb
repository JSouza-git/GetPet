...
class AgendamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agendamento" do
    assert_difference('Agendamento.count') do
      post agendamentos_url, params: { agendamento: { data: @agendamento.data, observacao: @agendamento.observacao, pet_id: @agendamento.pet_id, servico_id: @agendamento.servico_id, usuario_id: @agendamento.usuario_id } }
    end
  ...
  test "should update agendamento" do
    patch agendamento_url(@agendamento), params: { agendamento: { data: @agendamento.data, observacao: @agendamento.observacao, pet_id: @agendamento.pet_id, servico_id: @agendamento.servico_id, usuario_id: @agendamento.usuario_id } }
